...
@Autonomous(name = "Autonomous Right Red Speciments")
public class Red_Right_Speciments extends CommandOpMode {
    ...
    public void init_toAlliance_0() {
        toAlliance_0 = drive.trajectorySequenceBuilder(current_pose)
            .setTangent(315)
            .splineToSplineHeading(allianceSampleLeft, Math.toRadians(360));
    }
