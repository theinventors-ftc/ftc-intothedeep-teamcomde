...
@Disabled
@TeleOp(name = "AutoSpecimenInTeleTest", group = "Test")
public class autoInTeleOp extends CommandOpMode {
    ...
    public void initAllianceRelated(RobotEx.Alliance alliance) {
        robot = new IntoTheDeepRobot(follower, robotMap, RobotConstants,
                                     RobotEx.OpModeType.TELEOP, alliance,
                                     false, pose);
    }
