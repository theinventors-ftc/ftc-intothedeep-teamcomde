...
@Autonomous(name = "Blue Left Preload")
public class Blue_Left_Preload extends CommandOpMode {
    ...
    private Pose2d
        ...
        parking = new Pose2d(
            1.25 * Tile, 0.5 * Tile, Math.toRadians(225)
        );
    /**
     * Trajectories
     */
    ...
    public void init_toParking() {
        toParking = drive.trajectorySequenceBuilder(current_pose)
            ...
            .splineTo(new Vector2d(1.5 * Tile, 1.5 * Tile), Math.toRadians(315))
